...
export class PopularGameServiceService {
  ...
  private url: string = `${this.BASE_URL}games?key=${this.API_KEY}&dates=${this.lastYear},${this.currentDate}&ordering=-rating&page_size=10`;

  constructor(private http: HttpClient) { }

  getPopularGames (): Observable<dataArray> {
